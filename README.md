...
Mineradio-LX 是基于 [XxHuberrr/Mineradio](https://github.com/XxHuberrr/Mineradio) 二次开发的 Windows 桌面音乐播放器。这个版本的重点是为 Mineradio 增加落雪兼容自定义音源能力，让播放地址可以优先从用户配置的 LX 音源获取。
